      ...
      <main className="container mx-auto px-4 pt-32 pb-20">
        ...
        >
          ...
          <div className="glass-panel p-8 space-y-6">
            <div>
              <label className="block text-sm font-medium mb-3 text-aurora-300">
                {t('categories.length')}
              </label>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="input-field mt-3 bg-aurora-500/10 border-aurora-400/40">
                  {result}
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-aurora-500/20">
              <p className="text-center text-lg">
                ...
                <span className="text-gray-400">
                  {categories[category][fromUnit].name}
                </span>{' '}
                <span className="text-gray-500">=</span>{' '}
                <span className="text-polar-300 font-semibold">{result}</span>{' '}
                <span className="text-gray-400">
                  {categories[category][toUnit].name}
                </span>
              </p>
            </div>
          </div>
